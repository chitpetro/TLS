...
{
    public partial class f_bcchitietbh : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        KetNoiDBDataContext db = new KetNoiDBDataContext();
        Boolean doubleclick1 = false;
        Boolean doubleclick2 = false;
        public f_bcchitietbh()
        {
            InitializeComponent();
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (new KetNoiDBDataContext().accounts.Single(t => t.id == Biencucbo.idnv).bcct != true)
                {
                    ck.Visible = false;
                }
            }
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "BÁO CÁO BÁN HÀNG").ToString();
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_bcchtitietbh" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Đơn vị - ຫົວໜ່ວຍ")
                {
                    var list = (from a in db.donvis
                                ...
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_bcchtitietbh",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (danhmuc.Text == "Hàng Hóa - ສິນຄ້າ")
            {
                try
                {
                    var lst = (from a in db.r_giasps where a.iddv == Biencucbo.donvi select new { id = a.idsp, name = a.tensp, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_bcchtitietbh" });
            ...
            else if (danhmuc.Text == "Đối Tượng - ເປົ້້າໝາຍ")
            {
                try
                {
                    var lst = (from a in db.doituongs select new { id = a.id, name = a.ten, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_bcchtitietbh" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Loại Xuất - ປະເພດການຈ່າຍ")
            {
                try
                {
                    var lst = (from a in db.dmpxuats select new { id = a.danhmuc, name = a.danhmuc_l == null ? "---" : a.danhmuc_l, key = a.danhmuc + Biencucbo.idnv + "f_bcchtitietbh" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Công Việc - ໜ້າວຽກ")
            {
                try
                {
                    var lst = (from a in db.congviecs select new { id = a.id, name = a.tencongviec, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_bcchtitietbh" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_bcchtitietbh" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_bcchtitietbh" select a;
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var lst2 = from a in db.r_pbanhangs
                               join b in db.dk_rps on a.iddv equals b.id
                               where b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_bcchtitietbh"
                               select a;
                    var lst3 = lst2;
                    var lst4 = lst2;
                    var lst5 = lst2;
                    ...
                    if (check1 != 0)
                    {
                        lst3 = from a in lst2
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Hàng Hóa - ສິນຄ້າ" && b.form == "f_bcchtitietbh"
                               select a;
                    }
                    else
                    {
                    ...
                    if (check2 != 0)
                    {
                        lst4 = from a in lst3
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Đối Tượng - ເປົ້້າໝາຍ" && b.form == "f_bcchtitietbh"
                               select a;
                    }
                    else
                    {
                    ...
                    //           where b.user == Biencucbo.idnv && b.loai == "Công Việc - ໜ້າວຽກ" && b.form == "f_bcchtitietbh"
                    //           select a;
                    //}
                    //else
                    //{
                    ...
                    //           where b.user == Biencucbo.idnv && b.loai == "Loại Xuất - ປະເພດການຈ່າຍ" && b.form == "f_bcchtitietbh"
                    //           select a;
                    //}
                    //else
                    //{
                    ...
                    //}
                    var lst = (from a in lst4
                               where a.ngayban >= DateTime.Parse(tungay.Text) && a.ngayban <= DateTime.Parse(denngay.Text)
                               select new
                               {
                                   id = a.id,
                                   ngayhd = a.ngayban,
                              ...
                              ).Select(t => new
                              {
                                  ...
                                  t.Key.dongia,
                                  t.Key.chietkhau,
                                  soluong = t.Sum(y => y.soluong),
                                  thanhtien = t.Sum(y => y.thanhtien),
                    ...
                    if (ck.Checked)
                    {
                        ...
                        {
                            case 0:
                                r_chitietxuatkho2 xtra2 = new r_chitietxuatkho2();
                                xtra2.DataSource = lst;
                                ReportPrintTool rpt2 = new ReportPrintTool(xtra2);
                                rpt2.PreviewForm.MdiParent = Application.OpenForms[0];
                                rpt2.PreviewForm.Text = "BÁO CÁO CHI TIẾT BÁN HÀNG";
                                rpt2.ShowPreview();
                                break;
                            case 1:
                                r_chitietxuatkho3 xtra = new r_chitietxuatkho3();
                                xtra.DataSource = lst;
                                ReportPrintTool rpt = new ReportPrintTool(xtra);
                                rpt.PreviewForm.MdiParent = Application.OpenForms[0];
                                rpt.PreviewForm.Text = "BÁO CÁO CHI TIẾT BÁN HÀNG";
                                rpt.ShowPreview();
                                break;
                        }
