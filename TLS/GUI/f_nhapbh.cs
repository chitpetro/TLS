...
namespace GUI
{
    public partial class f_nhapbh : DevExpress.XtraBars.Ribbon.RibbonForm
    {
                        ...
                        try
                        {
                            ...
                            for (int i = 0; i <= gridView1.RowCount - 1; i++)
                            {
                                ...
                                if (txtloainhap.Text == "Nhập mua - ຊື້ນຳເຂົ້າ")
                                {
                                    ...
                                    if (double.Parse(gridView1.GetRowCellValue(i, "thue").ToString()) != 0)
                                    {
                                    ...
                                    if (double.Parse(gridView1.GetRowCellValue(i, "chiphi").ToString()) != 0) ;
                                    {
                                        tk.moi(txtid.Text + i + "3", txtdv.Text, "PBCP", txtid.Text, txtngaynhap.DateTime, new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day), Convert.ToInt32(txt1.Text), txtdv.Text, txtiddt.Text, gridView1.GetRowCellValue(i, "diengiai").ToString(), "1562", "3311", thue * double.Parse(txttygia.Text), txttiente.Text, double.Parse(txttygia.Text), thue, gridView1.GetRowCellValue(i, "idsanpham").ToString(), "", txtidnv.Text, txtloainhap.Text, gridView1.GetRowCellValue(i, "idcv").ToString(), "", lbltendt.Text, txtghichu.Text, 0.0);
                                    }
                                }
