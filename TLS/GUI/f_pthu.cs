...
namespace GUI
{
    public partial class f_pthu : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void load()
        {
            ...
            try
            {
                var lst = (from a in db.pthus where a.iddv == Biencucbo.donvi && a.dv == "TM" select a.so).Max();
                var lst1 = (from b in db.pthus where b.iddv == Biencucbo.donvi && b.dv == "TM" select b).FirstOrDefault(t => t.so == lst);
                if (lst1 == null) return;
                txtid.Text = lst1.id;
                ...
                if (Biencucbo.hdpt == 0)
                {
                    ...
                    try
                    {
                        ...
                        if (lst1.Count == 0)
                        {
                            int so;
                            so = 2;
                            td.themtudong(check, so,"PT","Phiếu Thu Tiền Mặt");
                        ...
                        pthu.moipthu(txtid.Text, txtngaynhap.DateTime, txtiddt.Text, txtdv.Text, txtidnv.Text, txtghichu.Text, Convert.ToInt32(txt1.Text), txtsohd.Text, txttiente.Text, double.Parse(txttygia.Text), txtloaithu.Text, txttk.Text, "TM");
                        for (int i = 0; i <= gridView1.RowCount - 1; i++)
                        {
        ...
        private void f_pthu_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Phiếu Thu").ToString();
        ...
        private void btnlui_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                var lst = (from pn in db.pthus where pn.iddv == txtdv.Text select new { a = pn }).FirstOrDefault(x => x.a.so == so);
                if (lst == null) return;
                txtid.Text = lst.a.id;
                txtidnv.Text = lst.a.idnv;
                txtdv.Text = lst.a.iddv;
        ...
        private void btntoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (Biencucbo.hdpt != 2)
                return;
            try
        ...
        private void btnlast_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var lst1 = (from a in db.pthus where a.iddv == txtdv.Text select a).Max(t => t.so);
                var lst = (from pn in db.pthus where pn.iddv == txtdv.Text select new { a = pn }).FirstOrDefault(x => x.a.so == lst1);
                if (lst == null) return;
                txtid.Text = lst.a.id;
                txtidnv.Text = lst.a.idnv;
                txtdv.Text = lst.a.iddv;
        ...
        private void btnfirst_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var lst1 = (from a in db.pthus where a.iddv == txtdv.Text select a).Min(t => t.so);
                var lst = (from pn in db.pthus where pn.iddv == txtdv.Text select new { a = pn }).FirstOrDefault(x => x.a.so == lst1);
                if (lst == null) return;
                txtid.Text = lst.a.id;
                txtidnv.Text = lst.a.idnv;
