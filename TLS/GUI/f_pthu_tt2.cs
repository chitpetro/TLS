...
namespace GUI
{
    public partial class f_pthu_tt2 : Form
    {
        ...
        public void load()
        {
            ...
            var check = (from a in db.pthus where a.link == Biencucbo.thanhtoan && a.dv == "TM" select a);
            if (check.Count() == 0)
            {
                Biencucbo.hdpt = 0;
            ...
            else
            {
                if (Biencucbo.hdpt == 0)
                {
                    ...
                    try
                    {
                        ...
                        pthu.moipthu(txtid.Text, txtngaynhap.DateTime, txtiddt.Text, txtdv.Text, txtidnv.Text, txtghichu.Text, Convert.ToInt32(txt1.Text), txtsohd.Text, txttiente.Text, float.Parse(txttygia.Text), txtloaithu.Text, txttk.Text, "TM");
                        for (int i = 0; i <= gridView1.RowCount - 1; i++)
                        {
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            for (int i = 0; i <= gridView1.RowCount - 1; i++)
            {
                if (gridView1.GetRowCellDisplayText(i, "tkco").ToString() == "" || gridView1.GetRowCellDisplayText(i, "tkco").ToString() == null)
                {
                    Lotus.MsgBox.ShowWarningDialog("Thông tin chưa đầy đủ - Vui lòng kiểm tra lại!");
                    return;
                }
        ...
        private void f_pthu_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Phiếu Thu TT 2").ToString();
        ...
        private void btntygi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
