...
namespace GUI
{
    public partial class f_themsodubandau : Form
    {
        KetNoiDBDataContext db = new KetNoiDBDataContext();
        t_sodubandau sd = new t_sodubandau();
        t_tudong td = new t_tudong();
        public f_themsodubandau()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                else
                {
                    if (Biencucbo.hdsdbd == 0)
                    {
                        ...
                        sd.moi(a, Biencucbo.matk, txtiddt.Text, txtmadonvi.Text, double.Parse(txtpsno_nt.Text), double.Parse(txtpsco_nt.Text), txttiente.Text, double.Parse(txttygia.Text), double.Parse(txtpsno.Text), double.Parse(txtpsco.Text), 0.0, "");
                    ...
                    {
                        string a = Biencucbo.matk + txtiddt.Text + Biencucbo.idnv + DateTime.Now;
                        sd.sua(Biencucbo.ma, txtiddt.Text, txtmadonvi.Text, double.Parse(txtpsno_nt.Text), double.Parse(txtpsco_nt.Text), txttiente.Text, double.Parse(txttygia.Text), double.Parse(txtpsno.Text), double.Parse(txtpsco.Text), 0.0, "");
                        MessageBox.Show("Done!");
                        this.Close();
                    }
                    Biencucbo.hdsdbd = 2;
