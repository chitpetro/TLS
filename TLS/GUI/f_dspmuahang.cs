...
namespace GUI
{
    public partial class f_dspmuahang : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            try
            {
                var lst = from a in db.r_pmuahangs
        ...
        private void f_PN_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Danh Sách Phiếu Mua Hàng").ToString();
