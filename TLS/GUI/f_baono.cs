...
namespace GUI
{
    public partial class f_baono : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void load()
        {
            ...
            try
            {
                var lst = (from a in db.pchis where a.iddv == Biencucbo.donvi && a.dv == "BN" select a.so).Max();
                var lst1 = (from b in db.pchis where b.iddv == Biencucbo.donvi && b.dv == "BN" select b).FirstOrDefault(t => t.so == lst);
                if (lst1 == null) return;
        ...
        private void btnfirst_ItemClick_1(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (Biencucbo.hdpc != 2)
                return;
            try
