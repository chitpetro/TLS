...
namespace GUI
{
    public partial class f_PNbh : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            try
            {
                var lst = from a in db.r_pnhaps
                          where a.ngaynhap >= tungay && a.ngaynhap <= denngay && a.iddv == Biencucbo.donvi
                          select new
                          {
                              id = a.id,
                              ngaynhap = a.ngaynhap,
        ...
        private void f_PN_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Danh Sách Phiếu Nhập").ToString();
