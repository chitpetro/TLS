...
namespace GUI
{
    public partial class f_pthu_txn : Form
    {
        ...
        public void load()
        {
            ...
            try
            {
                ...
                var lst1 = (from b in db.pthus where b.iddv == Biencucbo.donvi && b.dv == "TM" select b).FirstOrDefault(t => t.id == Biencucbo.ma);
                if (lst1 == null) return;
        ...
        protected override void OnActivated(EventArgs e)
        {
            ...
            if (q == null) return;
            var lst = (from a in db.PhanQuyen2s where a.TaiKhoan == Biencucbo.phongban select a).Single(t => t.ChucNang == "btnpthu");
