...
{
    public partial class f_thcnncc : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_thcnncc" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Đơn vị - ຫົວໜ່ວຍ")
                {
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_thcnncc",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (danhmuc.Text == "Đối Tượng - ເປົ້້າໝາຍ")
            {
                try
                {
                    var lst = (from a in db.doituongs select new { id = a.id, name = a.ten, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_thcnncc" });
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_thcnncc" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_thcnncc" select a;
            ...
            try
            {
                ...
                else
                {
                    ...
                    var lst2 = from a in db.ct_tks
                               ...
                               where a.ngaychungtu >= tungay.DateTime && a.ngaychungtu <= denngay.DateTime && a.tk_co.Substring(0, 3) == "331"
                               && b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_thcnncc"
                               select a;
                    ...
                    if (check2 != 0)
                    {
                        lst3 = from a in lst2
                               ...
                               where b.user == Biencucbo.idnv && b.form == "f_thcnncc"
                               select a;
                    }
                    ...
                    var lst4 = from a in db.ct_tks
                               join b in db.dk_rps on a.iddv equals b.id
                               where a.ngaychungtu >= tungay.DateTime && a.ngaychungtu <= denngay.DateTime && a.tk_no.Substring(0, 3) == "331"
                               && b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_thcnncc"
                               select a;
                    var lst5 = lst4;
                    if (check2 != 0)
                    {
                        lst5 = from a in lst4
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Đối Tượng - ເປົ້້າໝາຍ" && b.form == "f_thcnncc"
                               select a;
                    }
                    else
                    {
                    ...
                    lst4 = from a in db.ct_tks
                           join b in db.dk_rps on a.iddv equals b.id
                           where a.ngaychungtu < tungay.DateTime && a.tk_no == "331"
                            && b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_thcnncc"
                           select a;
                    lst5 = lst4;
                    sodu = lstsodu;
                    ...
                    rpt.PreviewForm.Text = "BÁO CÁO TỔNG HỢP CÔNG NỢ NHÀ CUNG CẤP";
                    rpt.ShowPreview();
                }
            }
            catch (Exception ex)
