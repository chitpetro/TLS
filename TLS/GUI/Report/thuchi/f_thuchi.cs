...
{
    public partial class f_thuchi : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_thuchi" select a;
                    nhan.DataSource = lst;
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_thuchi",
                                    MaTim = LayMaTim(a)
                                });
            ...
            if (danhmuc.Text == "Tài Khoản")
            {
                try
                {
                    var list = (from a in db.dmtks
                                where a.active == true && a.loaitk == "TIỀN MẶT"
                                select new
                                {
                                    id = a.matk,
                                    name = a.tentk,
                                    key = a.matk + danhmuc.Text + Biencucbo.idnv + "f_thuchi",
                                });
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            if (danhmuc.Text == "Tài Khoản")
            {
                try
                {
                    ...
                    db.dk_rps.InsertOnSubmit(dk);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_thuchi" select a;
                    nhan.DataSource = lst2;
                    var lst = (from a in db.dmtks where a.active == true && a.loaitk == "TIỀN MẶT" select new { id = a.matk, name = a.tentk, key = a.matk + danhmuc.Text + Biencucbo.idnv + "f_thuchi" });
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_thuchi" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                ...
                else
                {
                    ...
                    if (tsntqd.IsOn)
                    {
                        ...
                        var lst3 = (from a in lst
                                    ...
                                    where b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_thuchi"
                                    select a.PS).Sum();
                        ...
                        lst = (from a in db.ct_tks
                               ...
                               orderby a.ngaychungtu ascending,
                                a.id descending
                               select new
                               {
                                   a.PS,
                        ...
                        rpt.PreviewForm.Text = "BÁO CÁO SỔ QUỸ TIỀN MẶT";
                        rpt.ShowPreview();
                    }
                    else
                    {
