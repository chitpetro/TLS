...
{
    public partial class f_chitietbaoco : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        KetNoiDBDataContext db = new KetNoiDBDataContext();
        Boolean doubleclick1 = false;
        Boolean doubleclick2 = false;
        public f_chitietbaoco()
        {
            InitializeComponent();
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_chitietbaoco" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Đơn vị - ຫົວໜ່ວຍ")
                {
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietbaoco",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (danhmuc.Text == "Loại chi - ປະເພດ")
            {
                try
                {
                    var lst = (from a in db.dmpchis select new { id = a.danhmuc, name = a.danhmuc_l == null ? "---" : a.danhmuc_l, key = a.danhmuc + Biencucbo.donvi + Biencucbo.idnv + "f_chitietbaoco" });
            ...
            else if (danhmuc.Text == "Mục Chi Phí - ບັນຊີລາຍຈ່າຍ")
            {
                try
                {
                    var lst = (from a in db.muccps select new { id = a.id, name = a.muccp1, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietbaoco" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Đối Tượng - ເປົ້້າໝາຍ")
            {
                try
                {
                    var lst = (from a in db.doituongs select new { id = a.id, name = a.ten, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietbaoco" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Công Việc - ໜ້າວຽກ")
            {
                try
                {
                    var lst = (from a in db.congviecs select new { id = a.id, name = a.tencongviec, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietbaoco" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Tài khoản")
            {
                try
                {
                    var lst = (from a in db.dmtks where a.active == true && a.loaitk == "TIỀN GỬI NGÂN HÀNG" select new { id = a.matk, name = a.tentk, key = a.matk + danhmuc.Text + Biencucbo.idnv + "f_chitietbaoco" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_chitietbaoco" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_chitietbaoco" select a;
                ...
                if (danhmuc.Text == "Loại chi - ປະເພດ")
                {
                    try
                    {
                        var lst = (from a in db.dmpchis select new { id = a.danhmuc, name = a.danhmuc_l == null ? "---" : a.danhmuc_l, key = a.danhmuc + Biencucbo.idnv + "f_chitietbaoco" });
                        nguon.DataSource = lst;
                        for (int i = gridView1.RowCount - 1; i >= 0; i--)
                        {
                            for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            try
            {
                ...
                else
                {
                    ...
                    var lst2 = from a in db.ct_tks
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_chitietbaoco"
                               select a;
                    ...
                    if (check1 != 0)
                    {
                        lst3 = from a in lst7
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Loại chi - ປະເພດ" && b.form == "f_chitietbaoco"
                               select a;
                    }
                    else
                    {
                    ...
                    if (check2 != 0)
                    {
                        lst4 = from a in lst3
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Đối Tượng - ເປົ້້າໝາຍ" && b.form == "f_chitietbaoco"
                               select a;
                    }
                    else
                    {
                    ...
                    if (check3 != 0)
                    {
                        lst5 = from a in lst4
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Công Việc - ໜ້າວຽກ" && b.form == "f_chitietbaoco"
                               select a;
                    }
                    else
                    {
                    ...
                    if (check4 != 0)
                    {
                        lst6 = from a in lst5
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Mục Chi Phí - ບັນຊີລາຍຈ່າຍ" && b.form == "f_chitietbaoco"
                               select a;
                    }
                    else
                    {
                    ...
                    Biencucbo.title = "BẢNG KÊ PHIẾU CHI TIỀN GỬI NGÂN HÀNG";
                    ...
                    rpt.PreviewForm.Text = "BÁO CÁO BẢNG KÊ PHIẾU CHI TIỀN GỬI NGÂN HÀNG";
                    rpt.ShowPreview();
                }
            }
            catch (Exception ex)
