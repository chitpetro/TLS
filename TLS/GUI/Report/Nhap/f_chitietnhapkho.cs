...
{
    public partial class f_chitietnhapkho : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_chitietnhapkho" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Kho - ສາງ")
                {
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietnhapkho",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (danhmuc.Text == "Hàng Hóa - ສິນຄ້າ")
            {
                try
                {
                    var lst = (from a in db.r_giasps where a.iddv == Biencucbo.donvi select new { id = a.idsp, name = a.tensp, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietnhapkho" });
            ...
            else if (danhmuc.Text == "Đối Tượng Cung Cấp - ເປົ້າໝາຍຜູ້ສະໜອງ")
            {
                try
                {
                    var lst = (from a in db.doituongs select new { id = a.id, name = a.ten, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietnhapkho" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Loại Nhập - ປະເພດການນຳເຂົ້າ")
            {
                try
                {
                    var lst = (from a in db.dmpnhaps select new { id = a.danhmuc, name = a.danhmuc_l == null ? "---" : a.danhmuc_l, key = a.danhmuc + Biencucbo.idnv + "f_chitietnhapkho" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Công Việc - ໜ້າວຽກ")
            {
                try
                {
                    var lst = (from a in db.congviecs select new { id = a.id, name = a.tencongviec, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_chitietnhapkho" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_chitietnhapkho" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_chitietnhapkho" select a;
            ...
            try
            {
                ...
                else
                {
                    ...
                    var lst2 = from a in db.r_pnhaps
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Kho - ສາງ" && b.form == "f_chitietnhapkho"
                               select a;
                    var lst3 = lst2;
                    var lst4 = lst2;
                    var lst5 = lst2;
                    ...
                    if (check1 != 0)
                    {
                        lst3 = from a in lst2
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Hàng Hóa - ສິນຄ້າ" && b.form == "f_chitietnhapkho"
                               select a;
                    }
                    else
                    {
                    ...
                    if (check2 != 0)
                    {
                        lst4 = from a in lst3
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Đối Tượng Cung Cấp - ເປົ້າໝາຍຜູ້ສະໜອງ" && b.form == "f_chitietnhapkho"
                               select a;
                    }
                    else
                    {
                    ...
                    if (check3 != 0)
                    {
                        lst5 = from a in lst4
                               ...
                               where b.user == Biencucbo.idnv && b.loai == "Công Việc - ໜ້າວຽກ" && b.form == "f_chitietnhapkho"
                               select a;
                    }
                    else
                    {
                    ...
                    {
                        lst6 = from a in lst5
                               join b in db.dk_rps on a.loainhap equals b.id
                               where b.user == Biencucbo.idnv && b.loai == "Loại Nhập - ປະເພດການນຳເຂົ້າ" && b.form == "f_chitietnhapkho"
                               select a;
                    }
                    else
                    {
                    ...
                    rpt.PreviewForm.Text = "BÁO CÁO CHI TIẾT NHẬP KHO";
                    rpt.ShowPreview();
                }
            }
            catch (Exception ex)
