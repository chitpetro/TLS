...
namespace GUI
{
    public partial class r_thxuatkho : DevExpress.XtraReports.UI.XtraReport
    {
        public r_thxuatkho()
        {
            InitializeComponent();
            ...
            tran_rp.tran9_new( txtkho, txtdoituong, txttime, ngay2, xrPageInfo2);
            ...
            { 
                ...
                {
                    if (c == xrTableCell1 || c == xrTableCell2 )
                    {
