...
{
    public partial class f_ctcnkh : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_ctcnkh" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Đơn vị - ຫົວໜ່ວຍ")
                {
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_ctcnkh",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (danhmuc.Text == "Đối Tượng - ເປົ້້າໝາຍ")
            {
                try
                {
                    var lst = (from a in db.doituongs select new { id = a.id, name = a.ten, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_ctcnkh" });
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_ctcnkh" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_ctcnkh" select a;
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //              where a.ngayhd < tungay.DateTime && a.loaixuat == "Xuất bán - ຈ່າຍອອກຂາຍ" &&  b.user == Biencucbo.idnv
                    //              select a;
                    var lstton1 = (from a in db.ct_tks
                                   join b in db.dk_rps on a.iddv equals b.id
                                   where a.ngaychungtu < tungay.DateTime && a.tk_no.Substring(0, 3) == "131"
                                   && b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_ctcnkh"
                                   select new
                                   {
                                       a.dt_no,
                                       a.PS,
                                             ...
                                             join b in db.dk_rps on a.iddv equals b.id
                                             where a.matk.Substring(0, 3) == "131"
                                             && b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_ctcnkh"
                                             select new
                                             {
                                                 dt_no = a.iddt,
                    ...
                    if (check2 != 0)
                    {
                        lstton2 = (from a in lstton1
                                   ...
                                   where
                                    b.user == Biencucbo.idnv && b.loai == "Đối Tượng - ເປົ້້າໝາຍ" && b.form == "f_ctcnkh"
                                   select a.PS).Sum();
                    }
                    else
                    {
                    ...
                    if (check2 != 0)
                    {
                        lstton4 = (from a in lstton3
                                   ...
                                   where b.user == Biencucbo.idnv && b.loai == "Đối Tượng - ເປົ້້າໝາຍ" && b.form == "f_ctcnkh"
                                   select a.PS).Sum();
                    }
                    else
                    {
                    ...
                    lstton1 = (from a in db.ct_tks
                               join b in db.dk_rps on a.iddv equals b.id
                               where a.ngaychungtu <= denngay.DateTime && a.tk_no.Substring(0, 3) == "131"
                               && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_ctcnkh"
                    ...
                    lstton3 = (from a in db.ct_tks
                               join b in db.dk_rps on a.iddv equals b.id
                               where a.ngaychungtu <= denngay.DateTime && a.tk_co.Substring(0, 3) == "131"
                               && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.user == Biencucbo.idnv && b.form == "f_ctcnkh"
                               select new
                               {
                                   a.dt_co,
                                   a.PS
                    ...
                    var lst6 = (from a in db.ct_tks
                                where a.ngaychungtu >= tungay.DateTime && a.ngaychungtu <= denngay.DateTime && ((a.tk_co == "131" || a.tk_co == "1311" || a.tk_co == "1312") || (a.tk_no == "131" || a.tk_no == "1311" || a.tk_no == "1312"))
                                select new
                                {
                                    ngay = a.ngaychungtu,
                                    idno = (a.tk_no == "131" || a.tk_no == "1311" || a.tk_no == "1312") ? a.machungtu : "",
                                    idco = (a.tk_co == "131" || a.tk_co == "1311" || a.tk_co == "1312") ? a.machungtu : "",
                                    iddt = (a.tk_no == "131" || a.tk_no == "1311" || a.tk_no == "1312") ? a.dt_no : a.dt_co,
                                    a.ghichu,
                                    a.tendt,
                                    diengiai = a.diengiai,
                                    a.iddv,
                                    no = (a.tk_no == "131" || a.tk_no == "1311" || a.tk_no == "1312") ? a.PS : a.PS - a.PS,
                                    co = (a.tk_co == "131" || a.tk_co == "1311" || a.tk_co == "1312") ? a.PS : a.PS - a.PS,
                                }
                                ).OrderBy(t => t.ngay);
                    ...
                    rpt.PreviewForm.Text = "BÁO CÁO CHI TIẾT CÔNG NỢ KHÁCH HÀNG";
                    rpt.ShowPreview();
                }
            }
            catch (Exception ex)
