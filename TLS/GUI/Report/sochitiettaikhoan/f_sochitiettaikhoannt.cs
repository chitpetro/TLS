...
{
    public partial class f_sochitiettaikhoannt : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        KetNoiDBDataContext db = new KetNoiDBDataContext();
        Boolean doubleclick1 = false;
        Boolean doubleclick2 = false;
        public f_sochitiettaikhoannt()
        {
            InitializeComponent();
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Sổ Chi Tiết Tài Khoản").ToString();
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Đơn vị - ຫົວໜ່ວຍ")
                {
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_sochitiettaikhoannt",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (danhmuc.Text == "Loại thu - ປະເພດ")
            {
                try
                {
                    var lst = (from a in db.dmloaithus select new { id = a.danhmuc, name = a.danhmuc_l == null ? "---" : a.danhmuc_l, key = a.danhmuc });
            ...
            else if (danhmuc.Text == "Mục Chi Phí - ບັນຊີລາຍຈ່າຍ")
            {
                try
                {
                    var lst = (from a in db.muccps select new { id = a.id, name = a.muccp1, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_sochitiettaikhoannt" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Đối Tượng - ເປົ້້າໝາຍ")
            {
                try
                {
                    var lst = (from a in db.doituongs select new { id = a.id, name = a.ten, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_sochitiettaikhoannt" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Tiền Tệ")
            {
                try
                {
                    var lst = (from a in db.tientes select new { id = a.tiente1, name = a.tiente1, key = a.tiente1 + danhmuc.Text + Biencucbo.idnv + "f_sochitiettaikhoannt" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Công Việc - ໜ້າວຽກ")
            {
                try
                {
                    var lst = (from a in db.congviecs select new { id = a.id, name = a.tencongviec, key = a.id + danhmuc.Text + Biencucbo.idnv + "f_sochitiettaikhoannt" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
            ...
            else if (danhmuc.Text == "Tài Khoản")
            {
                try
                {
                    var lst = (from a in db.dmtks where a.active == true select new { id = a.matk, name = a.tentk, key = a.matk + danhmuc.Text + Biencucbo.idnv + "f_sochitiettaikhoannt" });
                    nguon.DataSource = lst;
                    for (int i = gridView1.RowCount - 1; i >= 0; i--)
                    {
                        for (int j = 0; j < gridView2.DataRowCount; j++)
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a;
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < gridView2.DataRowCount; i++)
                {
                    ...
                    else if (gridView2.GetRowCellValue(i, "loai").ToString() == "Tiền Tệ")
                    {
                        checktt++;
                        Biencucbo.tientebc = "  " + Biencucbo.tientebc + gridView2.GetRowCellValue(i, "id").ToString() + ", ";
                    }
                ...
                {
                    Lotus.MsgBox.ShowWarningDialog("Chỉ chọn 1 trường tài khoản duy nhất");
                    return;
                }
                else
                {
                    ...
                    Biencucbo.toncuoi = 0;
                    Biencucbo.kieusodu = "";
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" && a.loai == "Đơn vị - ຫົວໜ່ວຍ" select a);
                    ...
                    lst = (from a in db.dk_rps where a.loai == "Công Việc - ໜ້າວຽກ" && a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a);
                    if (check3 != 0)
                    {
                    ...
                    lst = (from a in db.dk_rps where a.loai == "Tiền Tệ" && a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a);
                    if (checktt != 0)
                    {
                        lst5a = (from a in lst4a
                                 join b in lst on a.tiente equals b.id
                                 select a);
                    }
                    else
                    {
                    ...
                    lst4a = lst5a;
                    lst = (from a in db.dk_rps where a.loai == "Mục Chi Phí - ບັນຊີລາຍຈ່າຍ" && a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a);
                    if (check4 != 0)
                    {
                        lst5a = (from a in lst4a
                    ...
                    sodu = (from a in lstsodu
                            ...
                            select a);
                    lstsodu = sodu;
                    lst = (from a in db.dk_rps where a.loai == "Đối Tượng - ເປົ້້າໝາຍ" && a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a);
                    if (check2 != 0)
                    {
                    ...
                    lst = (from a in db.dk_rps where a.loai == "Tài Khoản Đối Ứng" && a.user == Biencucbo.idnv && a.form == "f_sochitiettaikhoannt" select a);
                    ...
                    if (check6 != 0)
                    {
                        ...
                        lst6a = (from a in lst3a
                                 join b in tk on a.tk_no equals b.matk
                                 select new
                                 { PS = a.PS_nt }).Concat(from a in lstsodu
                                                          select new
                                                          {
                                                              PS = a.psco_nt,
                                                          });
                    ...
                    var lst2 = (from a in lst5a
                                ...
                                select new
                                {
                                    ...
                                    a.iddv,
                                    iddt = a.dt_co,
                                    psno = a.PS_nt - a.PS_nt,
                                    psco = a.PS_nt,
                                    a.tiente
                                }).Concat(from a in lst5a
                                          join b in tk on a.tk_no equals b.matk
                                          where a.ngaychungtu >= tungay.DateTime && a.ngaychungtu <= denngay.DateTime
                                          select new
                                          {
