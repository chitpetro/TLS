...
{
    public partial class f_baocaolctt : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Báo Cáo Lưu Chuyển Tiền Tệ").ToString();
            ...
            try
            {
                var lst = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_baocaolctt" select a;
                nhan.DataSource = lst;
                if (danhmuc.Text == "Đơn vị - ຫົວໜ່ວຍ")
                {
                    var list = (from a in db.donvis
                                select new
                                {
                                    id = a.id,
                                    name = a.tendonvi,
                                    key = a.id + danhmuc.Text + Biencucbo.idnv + "f_baocaolctt",
                                    MaTim = LayMaTim(a)
                                });
        ...
        private void gridView2_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (doubleclick2 == true)
            {
                ...
                {
                    dk_rp dk = new dk_rp();
                    var lst = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_baocaolctt" select a).Single(t => t.key == gridView2.GetFocusedRowCellValue("key").ToString());
                    db.dk_rps.DeleteOnSubmit(lst);
                    db.SubmitChanges();
                    var lst2 = from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_baocaolctt" select a;
            ...
            try
            {
                ...
                if (check != 0)
                {
                    lst1 = (from a in db.ct_tks
                            ...
                            where b.user == Biencucbo.idnv && b.loai == "Đơn vị - ຫົວໜ່ວຍ" && b.form == "f_baocaolctt"
                            select a);
                ...
                var lstps = (from a in db.dk_rps where a.user == Biencucbo.idnv && a.form == "f_baocaolctt" && a.loai == "Đơn vị - ຫົວໜ່ວຍ" select a);
                var ps = (from a in lst1
                          ...
                          select new
                          {
                              ...
                              tk_coc3 = tkc3(a.tk_co),
                              tk_noc3 = tkc3(a.tk_no),
                          }).ToList();
                // Năm trước
                //01
                var gt = (from a in ps
                ...
                //04
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "635" )|| (a.tk_co == "111" && a.tk_no == "335") || (a.tk_co == "111" && a.tk_no == "242")
                         || (a.tk_co == "112" && a.tk_no == "635") || (a.tk_co == "112" && a.tk_no == "335")|| (a.tk_co == "112" && a.tk_no == "242")
                         || (a.tk_co == "113" && a.tk_no == "635") || (a.tk_co == "113" && a.tk_no == "335") || (a.tk_co == "113" && a.tk_no == "242")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt04 = 0;
                ...
                //21
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "211") || (a.tk_co == "111" && a.tk_no == "213") || (a.tk_co == "111" && a.tk_no == "217") || (a.tk_co == "111" && a.tk_no == "241") || (a.tk_co == "111" && a.tk_no == "331") || (a.tk_co == "111" && a.tk_noc2 == "3411")
                         || (a.tk_co == "112" && a.tk_no == "211") || (a.tk_co == "112" && a.tk_no == "213") || (a.tk_co == "112" && a.tk_no == "217") || (a.tk_co == "112" && a.tk_no == "241") || (a.tk_co == "112" && a.tk_no == "331") || (a.tk_co == "112" && a.tk_noc2 == "3411")
                         || (a.tk_co == "113" && a.tk_no == "211") || (a.tk_co == "113" && a.tk_no == "213") || (a.tk_co == "113" && a.tk_no == "217") || (a.tk_co == "113" && a.tk_no == "241") || (a.tk_co == "113" && a.tk_no == "331") || (a.tk_co == "113" && a.tk_noc2 == "3411")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt21 = 0;
                ...
                //25
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "221") || (a.tk_co == "111" && a.tk_no == "222") || (a.tk_co == "111" && a.tk_noc2 == "2281") || (a.tk_co == "111" && a.tk_no == "331")
                         || (a.tk_co == "112" && a.tk_no == "221") || (a.tk_co == "112" && a.tk_no == "222") || (a.tk_co == "112" && a.tk_noc2 == "2281") || (a.tk_co == "112" && a.tk_no == "331")
                         || (a.tk_co == "113" && a.tk_no == "221") || (a.tk_co == "113" && a.tk_no == "222") || (a.tk_co == "113" && a.tk_noc2 == "2281") || (a.tk_co == "113" && a.tk_no == "331")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt25 = 0;
                ...
                //26 
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "221") || (a.tk_no == "111" && a.tk_co == "222") || (a.tk_no == "111" && a.tk_coc2 == "2281") || (a.tk_no == "111" && a.tk_co == "131")
                         || (a.tk_no == "112" && a.tk_co == "221") || (a.tk_no == "112" && a.tk_co == "222") || (a.tk_no == "112" && a.tk_coc2 == "2281") || (a.tk_no == "112" && a.tk_co == "131")
                         || (a.tk_no == "113" && a.tk_co == "221") || (a.tk_no == "113" && a.tk_co == "222") || (a.tk_no == "113" && a.tk_coc2 == "2281") || (a.tk_no == "113" && a.tk_co == "131")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt26 = 0;
                ...
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "515") || (a.tk_no == "112" && a.tk_co == "515") 
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt27 = 0;
                ...
                //33
                gt = (from a in ps
                      where  (a.tk_no == "111" && a.tk_co == "171") || (a.tk_no == "111" && a.tk_coc2 == "3411") || (a.tk_no == "111" && a.tk_coc2 == "3431") || (a.tk_no == "111" && a.tk_coc2 == "3432") || (a.tk_no == "111" && a.tk_coc3 == "41112")
                          || (a.tk_no == "112" && a.tk_co == "171") || (a.tk_no == "112" && a.tk_coc2 == "3411") || (a.tk_no == "112" && a.tk_coc2 == "3431") || (a.tk_no == "112" && a.tk_coc2 == "3432") || (a.tk_no == "112" && a.tk_coc3 == "41112")
                          || (a.tk_no == "113" && a.tk_co == "171") || (a.tk_no == "113" && a.tk_coc2 == "3411") || (a.tk_no == "113" && a.tk_coc2 == "3431") || (a.tk_no == "113" && a.tk_coc2 == "3432") || (a.tk_no == "113" && a.tk_coc3 == "41112")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt33 = 0;
                ...
                //34
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "171") || (a.tk_co == "111" && a.tk_noc2 == "3411") || (a.tk_co == "111" && a.tk_noc2 == "3431") || (a.tk_co == "111" && a.tk_noc2 == "3432") || (a.tk_co == "111" && a.tk_noc3 == "41112")
                         || (a.tk_co == "112" && a.tk_no == "171") || (a.tk_co == "112" && a.tk_noc2 == "3411") || (a.tk_co == "112" && a.tk_noc2 == "3431") || (a.tk_co == "112" && a.tk_noc2 == "3432") || (a.tk_co == "112" && a.tk_noc3 == "41112")
                         || (a.tk_co == "113" && a.tk_no == "171") || (a.tk_co == "113" && a.tk_noc2 == "3411") || (a.tk_co == "113" && a.tk_noc2 == "3431") || (a.tk_co == "113" && a.tk_noc2 == "3432") || (a.tk_co == "113" && a.tk_noc3 == "41112")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt34 = 0;
                ...
                //36
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "421") || (a.tk_co == "111" && a.tk_no == "338")
                      || (a.tk_co == "112" && a.tk_no == "421") || (a.tk_co == "112" && a.tk_no == "338")
                      || (a.tk_co == "113" && a.tk_no == "421") || (a.tk_co == "113" && a.tk_no == "338")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt36 = 0;
                ...
                //61
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_coc2 == "4131")
                      || (a.tk_no == "112" && a.tk_coc2 == "4131")
                      || (a.tk_no == "113" && a.tk_coc2 == "4131")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tt61 = 0;
                ...
                {
                    Candoi.tt61 = double.Parse(gt.Sum(t => t.PS).ToString());
                }
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_noc2 == "4131")
                      || (a.tk_co == "112" && a.tk_noc2 == "4131")
                      || (a.tk_co == "113" && a.tk_noc2 == "4131")
                      select a);
                if (gt.Count() == 0)
                {
                ...
                {
                    Candoi.tt61 = Candoi.tt61 - double.Parse(gt.Sum(t => t.PS).ToString());
                }
                ...
                //02 (bổ sung thêm 158)
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "331") || (a.tk_co == "111" && a.tk_no == "151") || (a.tk_co == "111" && a.tk_no == "152") || (a.tk_co == "111" && a.tk_no == "153") || (a.tk_co == "111" && a.tk_no == "154") || (a.tk_co == "111" && a.tk_no == "155") || (a.tk_co == "111" && a.tk_no == "156") || (a.tk_co == "111" && a.tk_no == "157") || (a.tk_co == "111" && a.tk_no == "158")
                         || (a.tk_co == "112" && a.tk_no == "331") || (a.tk_co == "112" && a.tk_no == "151") || (a.tk_co == "112" && a.tk_no == "152") || (a.tk_co == "112" && a.tk_no == "153") || (a.tk_co == "112" && a.tk_no == "154") || (a.tk_co == "112" && a.tk_no == "155") || (a.tk_co == "112" && a.tk_no == "156") || (a.tk_co == "112" && a.tk_no == "157") || (a.tk_co == "112" && a.tk_no == "158")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tn02 = 0;
                ...
                {
                    Candoi.tn02 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //03
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "334") || (a.tk_co == "112" && a.tk_no == "334")
                ...
                {
                    Candoi.tn03 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //04
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "335") || (a.tk_co == "111" && a.tk_no == "635") || (a.tk_co == "111" && a.tk_no == "242")
                      || (a.tk_co == "112" && a.tk_no == "335") || (a.tk_co == "112" && a.tk_no == "635") || (a.tk_co == "112" && a.tk_no == "242")
                      || (a.tk_co == "113" && a.tk_no == "335") || (a.tk_co == "113" && a.tk_no == "635") || (a.tk_co == "113" && a.tk_no == "242")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tn04 = 0;
                ...
                {
                    Candoi.tn04 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //05
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_noc2 == "3334") || (a.tk_co == "112" && a.tk_noc2 == "3334") || (a.tk_co == "113" && a.tk_noc2 == "3334")
                ...
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "711") || (a.tk_no == "111" && a.tk_co == "133") || (a.tk_no == "111" && a.tk_co == "141") || (a.tk_no == "111" && a.tk_co == "244")
                         || (a.tk_no == "112" && a.tk_co == "711") || (a.tk_no == "112" && a.tk_co == "133") || (a.tk_no == "112" && a.tk_co == "141") || (a.tk_no == "112" && a.tk_co == "244")
                         //|| (a.tk_no == "113" && a.tk_co == "711") || (a.tk_no == "113" && a.tk_co == "133") || (a.tk_no == "113" && a.tk_co == "141") || (a.tk_no == "113" && a.tk_co == "244")
                      select a);
                if (gt.Count() == 0)
                {
                    Candoi.tn06 = 0;
                ...
                {
                    Candoi.tn07 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //20
                ...
                {
                    Candoi.tn21 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //22
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "711") || (a.tk_no == "111" && a.tk_coc2 == "5117") || (a.tk_no == "111" && a.tk_co == "131")
                ...
                {
                    Candoi.tn23 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //24
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "128") || (a.tk_no == "111" && a.tk_co == "171")
                ...
                {
                    Candoi.tn25 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //26 
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "221") || (a.tk_no == "111" && a.tk_co == "222") || (a.tk_no == "111" && a.tk_coc2 == "2281") || (a.tk_no == "111" && a.tk_co == "131")
                ...
                {
                    Candoi.tn32 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //33
                gt = (from a in ps
                      where (a.tk_no == "111" && a.tk_co == "171") || (a.tk_no == "111" && a.tk_coc2 == "3411") || (a.tk_no == "111" && a.tk_coc2 == "3431") || (a.tk_no == "111" && a.tk_coc2 == "3432") || (a.tk_no == "111" && a.tk_coc3 == "41112")
                ...
                {
                    Candoi.tn34 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //35
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_noc2 == "3412")
                ...
                {
                    Candoi.tn35 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                //36
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_no == "421") || (a.tk_co == "111" && a.tk_no == "338")
                ...
                {
                    Candoi.tn36 = double.Parse(gt.Sum(t => t.PS).ToString()) * (-1);
                }
                ...
                {
                    Candoi.tn61 = double.Parse(gt.Sum(t => t.PS).ToString());
                }
                gt = (from a in ps
                      where (a.tk_co == "111" && a.tk_noc2 == "4131")
                      || (a.tk_co == "112" && a.tk_noc2 == "4131")
                ...
                {
                    Candoi.tn61 = Candoi.tn61 - double.Parse(gt.Sum(t => t.PS).ToString());
                }
                ...
                rpt.PreviewForm.Text = "Báo Cáo Lưu Chuyển Tiền Tệ";
                rpt.ShowPreview();
                //}
