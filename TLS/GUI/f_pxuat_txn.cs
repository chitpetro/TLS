...
namespace GUI
{
    public partial class f_pxuat_txn : Form
    {
        ...
        protected override void OnActivated(EventArgs e)
        {
            ...
            if (q == null) return;
            var lst = (from a in db.PhanQuyen2s where a.TaiKhoan == Biencucbo.phongban select a).Single(t => t.ChucNang == "btnxuat");
        ...
        public void load()
        {
            ...
            try
            {
                var lst1 = (from b in db.pxuats where b.iddv == Biencucbo.donvi select b).FirstOrDefault(t => t.id == Biencucbo.ma);
                if (lst1 == null) return;
